...
dataDir = fullfile('C:','Users','User','Documents','Umass Amherst', 'Semester 1', 'COMPSCI 670 - Computer Vision','Mini Projects','1','p1_data','data','prokudin-gorskii');

% Path to your output directory (change this to your output directory)
outDir = fullfile('C:','Users','User','Documents','Umass Amherst', 'Semester 1', 'COMPSCI 670 - Computer Vision','Mini Projects','1','p1_data','data', 'output', 'prokudin-gorskii');
...
for i = 1:length(imageNames),
    ...
    channels(:,:,3) = im(1:imageHeight,:); %B 
    channels(:,:,2) = im(imageHeight+1:2*imageHeight,:); %G
    channels(:,:,1) = im(2*imageHeight+1:3*imageHeight,:); %R
